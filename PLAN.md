...
- **Website AI Schedule**: Appearance can keep a selected Smart Bot available continuously or limit website-widget answering to inside/outside weekly office hours in an explicit IANA timezone. Server-side evaluation controls generation and the widget handoff state; messages received while AI rests remain available to live agents.
