...
class LandingPageController extends Controller
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'landing.hero_subtitle'      => 'Bring WhatsApp, Messenger, Instagram, Telegram Business, Gmail, live chat and ecommerce conversations into one AI-powered workspace — with smart replies and a dedicated app for agents on the move.',
