...
class LandingPageController extends Controller
{
    ...
    public static function defaults(): array
    {
        return [
            ...
            'landing.seo_description' => 'WisperBot unifies WhatsApp, Messenger, Instagram, Telegram Business, Gmail, ecommerce and live chat in one AI-powered support desk, with automated replies and a dedicated agent app.',
            'landing.seo_keywords'    => 'omnichannel inbox, Gmail shared inbox, Telegram Business, WhatsApp Business API, AI reply automation, ecommerce customer support, Shopify support, WooCommerce support, mobile agent app, customer messaging platform',
            ...
            'landing.hero_subtitle'      => 'Unify WhatsApp, Messenger and Instagram, Tiktok, Emails, eCommerce automate replies with AI chatbots, run bulk broadcasts, and turn conversations into revenue — all from one platform.',
            ...
            'landing.channel_5_desc'  => 'Connect multiple Gmail, Microsoft or IMAP mailboxes, then read and reply from Email MasterBox.',

            // ── Connected operations ──────────────────────────────────────────
            'landing.platforms_enabled'  => '1',
            'landing.platforms_badge'    => 'Connected customer operations',
            'landing.platforms_title'    => 'Messages, orders and AI replies in one workspace',
            'landing.platforms_subtitle' => 'WisperBot connects the tools your customers already use, so support teams can work from one inbox on web or mobile.',
            'landing.platform_1_icon'     => 'mail',
            'landing.platform_1_title'    => 'Gmail & Email MasterBox',
            'landing.platform_1_desc'     => 'Connect multiple Gmail, Microsoft and IMAP inboxes, read every thread together, and compose replies without switching tabs.',
            'landing.platform_2_icon'     => 'send',
            'landing.platform_2_title'    => 'Telegram Business',
            'landing.platform_2_desc'     => 'Route Telegram Business conversations into the same team inbox used for your other customer channels.',
            'landing.platform_3_icon'     => 'shopping-cart',
            'landing.platform_3_title'    => 'Ecommerce Connections',
            'landing.platform_3_desc'     => 'Connect Shopify and WooCommerce stores, sync products and orders, and give agents useful commerce context while they reply.',
            'landing.platform_4_icon'     => 'cpu',
            'landing.platform_4_title'    => 'AI Reply Automation',
            'landing.platform_4_desc'     => 'Ground smart bots in your knowledge bases and catalog, automate concise multilingual answers, and hand conversations to a human when needed.',
            'landing.platform_5_icon'     => 'smartphone',
            'landing.platform_5_title'    => 'Dedicated Agent App',
            'landing.platform_5_desc'     => 'Let your team receive notifications and answer customers from the dedicated mobile agent experience wherever they are.',
            'landing.platform_6_icon'     => 'store',
            'landing.platform_6_title'    => 'Seller Messaging',
            'landing.platform_6_desc'     => 'Bring supported eBay and Amazon seller communication into your customer workflow after connecting approved seller accounts.',
            ...
            'landing.faq_1_a'       => 'WhatsApp Business, Facebook Messenger, Instagram DMs, Telegram Business, Gmail and other connected email inboxes can be managed alongside website chat. Supported ecommerce and seller connections add order and customer context too.',
            ...
            'landing.intcat_5_title' => 'Email & Productivity',
            'landing.intcat_5_items' => "Gmail\nMicrosoft Mail\nIMAP / SMTP\nGoogle Sheets",
