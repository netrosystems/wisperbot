...
class NewMessageNotification extends Notification implements ShouldQueue, WorkspaceScopedNotification
{
    ...
    public function via(object $notifiable): array
    {
        ...
        // OneSignal is primary. Native VAPID remains a fallback only when it
        // has not been configured, preventing duplicate push alerts.
