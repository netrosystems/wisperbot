...
class DefaultTranslations
{
    ...
    private static function nav(): array
    {
        return [
            ...
            'nav.addons' => 'Addons',
            'nav.omni_channel_inbox' => 'Omni Channel Inbox',
            'nav.inbox_channel_setup' => 'Inbox Channel Setup',
            'nav.website_chatbot' => 'Chatbot Widget',
            'nav.widgets' => 'Widgets',
            'nav.widget_settings' => 'Widget Settings',
            'nav.app_integration' => 'App Integration',
            'nav.group_chatbot_widget' => 'Chatbot Widget',
            'nav.wa_chatbot' => 'WA Chatbot',
            'nav.post_automation' => 'Post Automation',
            'nav.calendar_view' => 'Calendar View',
            'nav.connected_social_media' => 'Connected Social Media',
            'nav.sms_campaigns' => 'SMS Campaigns',
            'nav.connected_stores' => 'Connected Stores',
            'nav.smart_bots' => 'Smart Bots',
            'nav.inbox_agents' => 'Inbox & Agents',
            'nav.group_landing' => 'Landing',
            'nav.group_chatbot_setup' => 'Chatbot Setup',
            'nav.group_wa_messaging' => 'WA Messaging',
            'nav.group_ai_automations' => 'AI Automations',
            'nav.group_assets' => 'Group Assets',
            'nav.pricing' => 'Pricing',
