...
const SETUP_GUIDES = {
    ...
    oauth_linkedin: {
        ...
        steps: [
            ...
            'For Company Page posting, create a SECOND LinkedIn app: LinkedIn only grants the Community Management API to an app that has no other product, so it cannot be added to the app above.',
            'On that second app request the Community Management API, add the same Callback URL, and wait for LinkedIn to approve it.',
            'After approval, paste its keys into "Company Page Client ID" and "Company Page Client Secret" above. Clients then see a LinkedIn Company Page option when connecting. Leave them empty to stay personal-profile only.',
        ],
...
const BRAND = {
    ...
    meta_pixel:                { bg: 'bg-blue-100 dark:bg-blue-900/30', color: '#0866FF', icon: <svg viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5"><path d="M2.5 10C2.5 7.24 4.74 5 7.5 5c1.32 0 2.52.5 3.42 1.32A5 5 0 0114.5 5C17.26 5 19.5 7.24 19.5 10v.5c0 2.76-2.24 5-5 5a5 5 0 01-3.58-1.5A5 5 0 017.5 15.5C4.74 15.5 2.5 13.26 2.5 10.5V10zm5 3.5c1.38 0 2.5-1.12 2.5-2.5v-.5c0-1.38-1.12-2.5-2.5-2.5S5 9.12 5 10.5V11c0 1.38 1.12 2.5 2.5 2.5zm7 0c1.38 0 2.5-1.12 2.5-2.5V10c0-1.38-1.12-2.5-2.5-2.5S12 8.62 12 10v.5c0 1.38 1.12 2.5 2.5 2.5z" /></svg> },
